...
# Iitialize session state for tracking user input and responses
...
backend_url = "http://127.0.0.1:6000/chat_batch"

# Function to handle sending messages and receiving responses
def handle_message(user_input):
    if user_input:
        # Add the user_input to the session state
        ...
        if response.status_code == 200:
            ...
            <div style = "background-color:#f0f0f0; padding: 10px; border-radius: 5px;">
                <p style = "font-family:Arial, san-serif;">{bot_response.strip()}
